...
var sad_sound;
var eating_sound;
var starimg, star1, star2, scoreEmpty, score1, stars, score;
var blower;
...
function preload()
{
  ...
  scoreEmpty = loadAnimation("empty.png");
...
function setup() 
{
  ...
  score = createSprite(150, 20, 30, 30);
  score.addAnimation('empty',scoreEmpty);
  score.addAnimation('one', score1);
  score.addAnimation('two', stars);
